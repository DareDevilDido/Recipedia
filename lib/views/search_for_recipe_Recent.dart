...
class _search_for_recipe_RecentState extends State<search_for_recipe_Recent> {
  bool filterApplied = false;
  int selectedRating = 0;
  List<String> selectedCategories = [];
void showFilterDialog(BuildContext context) {
      ...
      body:Scrollbar(child:Padding(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 16.0),
            const Text("Recent Search",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20 ,color:Colors.black ))
